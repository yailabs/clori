...
- `README.md` is the compact public entry.
...
README changes are limited to the public purpose, working workflow, measured
current evidence, material limits, and navigation. Historical documents are
