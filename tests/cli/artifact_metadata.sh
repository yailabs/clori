...
"$YVEX_BIN" profile verify "$ALIAS" --registry "$DTYPE_REG" --audit \
...
"$YVEX_BIN" profile verify "$ALIAS" --registry "$DIMS_REG" --audit \
...
"$YVEX_BIN" profile verify "$ALIAS" --registry "$ARCH_REG" --audit \
