...
grep 'inspect target decision --release v0.1.0' "$ROOT/model-target-help.out"
grep 'inspect target class-profile TARGET' "$ROOT/model-target-help.out"
grep 'inspect target tensor-collection TARGET' "$ROOT/model-target-help.out"
grep 'inspect target tensor-map TARGET' "$ROOT/model-target-help.out"
grep 'inspect target missing-roles TARGET' "$ROOT/model-target-help.out"
...
grep 'boundary: inspect tensor collection inventory only; no role mapping/runtime/generation' "$ROOT/tensor-collection-qwen-missing.out"
...
grep 'boundary: inspect tensor collection inventory only; no role mapping/runtime/generation' "$ROOT/tensor-collection-gemma-missing.out"
...
grep 'boundary: inspect tensor collection inventory only; no role mapping/runtime/generation' "$ROOT/tensor-collection-qwen.out"
...
expect_rc 2 "$YVEX_BIN" inspect target quant-policy qwen3-8b --check-output-contract > "$ROOT/qtype-policy-contract-missing-mode.out"
...
grep 'boundary: inspect tensor collection inventory only; no role mapping/runtime/generation' "$ROOT/tensor-collection-gemma.out"
...
expect_rc 2 "$YVEX_BIN" inspect target tensor-map qwen3-8b --check-output-contract > "$ROOT/tensor-map-contract-missing-mode.out"
...
grep 'usage: yvex inspect target decision --release v0.1.0' "$ROOT/model-target-decision-help.out"
