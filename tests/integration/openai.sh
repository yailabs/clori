#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v10 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v10 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
