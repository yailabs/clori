#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v17 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v17 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
