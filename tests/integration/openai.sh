#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v6 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v6 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
