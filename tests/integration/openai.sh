#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v12 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v12 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
