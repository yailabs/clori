#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v14 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v14 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
