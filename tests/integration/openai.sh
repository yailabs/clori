#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v13 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v13 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
