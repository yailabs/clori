#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v18 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v18 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
