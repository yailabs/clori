#!/bin/sh
# Exercises production HTTP/SSE translation over the real local protocol v19 codec.
set -eu
...
echo 'OpenAI adapter integration: protocol-v19 Chat/Responses/SSE/tool/state/cleanup/refusal passed'
