...
require_text README.md './yvex server load deepseek4-v4-flash-dspark-runtime-iq2xxs'
require_text README.md './yvex server models'
require_text README.md './yvex server memory'
require_text README.md './yvex server unload deepseek4-v4-flash-dspark-runtime-iq2xxs'
require_text README.md './yvex chat --model deepseek4-v4-flash-dspark-runtime-iq2xxs --session main'
require_text README.md './yvex run --model deepseek4-v4-flash-dspark-runtime-iq2xxs'
...
require_text docs/contracts/local-protocol.md 'YVEX_LOCAL_PROTOCOL_VERSION = 13'
...
require_text docs/operator-runbook.md './yvex server load deepseek4-v4-flash-dspark-runtime-iq2xxs'
require_text docs/operator-runbook.md './yvex server models'
require_text docs/operator-runbook.md './yvex server unload'
