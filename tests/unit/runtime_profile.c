...
int yvex_test_runtime_profile(void)
{
    ...
    YVEX_TEST_ASSERT(
        profile_fixture(&record, &err) == YVEX_OK &&
            ...
            !strcmp(yvex_runtime_profile_counter_name(
    ...
    YVEX_TEST_ASSERT(
        ...
        yvex_runtime_profile_counter_add(
            ...
            0ull, &err) == YVEX_OK &&
        yvex_runtime_profile_phase_add(
            &record, YVEX_RUNTIME_PROFILE_ATTENTION, 9000ull, &err) == YVEX_OK,
        "profile accepts checked counters and measured phases");
    YVEX_TEST_ASSERT(yvex_runtime_profile_finish(&record, &err) == YVEX_OK &&
                         yvex_runtime_profile_validate(&record, &err) == YVEX_OK &&
    ...
    YVEX_TEST_ASSERT(
        yvex_runtime_profile_validate(&mutated, &err) == YVEX_ERR_FORMAT,
                     "profile mutation is rejected");
    YVEX_TEST_ASSERT(yvex_runtime_profile_counter_add(
    ...
    YVEX_TEST_ASSERT(yvex_runtime_profile_begin(
    ...
    YVEX_TEST_ASSERT(!strcmp(
                         yvex_runtime_profile_mode_name(YVEX_RUNTIME_PROFILE_STAGES),
                             "stages") &&
                         !strcmp(yvex_runtime_profile_phase_name(
                         ...
                         !strcmp(yvex_runtime_profile_counter_name(
                                 ...
                                 "kernel_launches") &&
                         !strcmp(yvex_runtime_profile_counter_name(
                                     YVEX_RUNTIME_PROFILE_ACCELERATED_MATRIX_LAUNCHES),
                                 "accelerated_matrix_launches") &&
                         !strcmp(yvex_runtime_profile_counter_name(
